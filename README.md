...
For example: **.../redb/parcel/legal_entity_id?IdInput=367&Current=True** would return 
<pre>
{
  "parcels": [
    {
...
This end point uses trigrams and fuzzy matching in order to return all the information related to an address in the database that most closely matches the AddressInput.<br>
